...
import griffon.swing.support.materialdesignicons.MaterialDesignIcon;
 ...
 */
public class MaterialDesignIconFactory extends AbstractFactory {
    @Override
    public Object newInstance(FactoryBuilderSupport builder, Object name, Object value, Map attributes) throws InstantiationException, IllegalAccessException {
        ...
        if (iconName instanceof CharSequence) {
            return new MaterialDesignIcon(iconName.toString());
        } else if (iconName instanceof MaterialDesignIconFont) {
            return new MaterialDesignIcon((MaterialDesignIconFont) iconName);
        }
