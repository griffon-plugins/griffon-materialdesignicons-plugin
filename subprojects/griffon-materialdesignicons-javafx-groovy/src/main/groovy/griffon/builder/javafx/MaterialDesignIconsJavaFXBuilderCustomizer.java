 ...
 */
@DependsOn({"javafx"})
@Named("materialdesignicons-javafx")
public class MaterialDesignIconsJavaFXBuilderCustomizer extends AbstractBuilderCustomizer {
    public MaterialDesignIconsJavaFXBuilderCustomizer() {
